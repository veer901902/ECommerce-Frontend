  ...
  return (
    <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        {/* This is personal Information part */}
        ...
        {/* This is Cart part */}
        <div className="mb-15 lg:col-span-2">
          <div className="mx-auto pt-1 mt-[50px] bg-white max-w-[900px] px-4 sm:px-6 lg:px-8">
